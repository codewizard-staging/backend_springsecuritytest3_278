package com.app.springsecuritytest3.model;
...
import com.app.springsecuritytest3.converter.DurationConverter;
import com.app.springsecuritytest3.converter.UUIDToByteConverter;
import com.app.springsecuritytest3.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"springsecuritytest3_867\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"springsecuritytest3_867\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"springsecuritytest3_867\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"springsecuritytest3_867\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"springsecuritytest3_867\"")
